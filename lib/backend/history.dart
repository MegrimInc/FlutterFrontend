...
class MerchantHistory with ChangeNotifier {
  ...
  int? get currentTappedMerchantId => _currentTappedMerchantId;
  ...
  Future<void> _loadTappedMerchantId() async {
    ...
    _currentTappedMerchantId = prefs.getInt('currentTappedMerchantId');
  ...
  Future<void> _saveTappedMerchantId() async {
    ...
    if (_currentTappedMerchantId != null) {
      await prefs.setInt('currentTappedMerchantId', _currentTappedMerchantId!);
    } else {
  ...
  void setTappedMerchantId(int merchantId) {
